...
import {
  getBrokerTopic, getControlData, putSubscribeData, removeControlData,
} from 'utils/tokens';
import TvMatchHeader from './TvMatchHeader';
import TvMatchScore from './TvMatchScore';

function TvMatchDetailsPage() {
...
export default TvMatchDetailsPage;
